...
class FlashArt:
    def __init__(self, vid_path, pxl_size=6, colour_lvl = 16):
        pygame.init()
    ...
    def load_image(self):
        ...
        if not temp:
            f2 = FlashArt('C:\\Users\\rebor\\Desktop\\Academics 2k21\\Group Project 2k21\\Flash Art\\VideoPix_FlashArt_ASCII\\FlashArt_VideosPix\\hagler1.mp4')
            f2.execute()
    ...
    def save_image(self):
        ...
        cv2.imwrite('C:\\Users\\rebor\\Desktop\\Academics 2k21\\Group Project 2k21\\Flash Art\\VideoPix_FlashArt_ASCII\\FlashArtOutput_VideoPix\\Flash_Art_Image.png', cv_image)
...
flash_art = FlashArt('C:\\Users\\rebor\\Desktop\\Academics 2k21\\Group Project 2k21\\Flash Art\\VideoPix_FlashArt_ASCII\\FlashArt_VideosPix\\hagler1.mp4')
flash_art.execute()